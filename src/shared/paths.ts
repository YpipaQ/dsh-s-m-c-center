...
export const STORE_ROOT_NAME = 'S-M-C'

/** Sub-directory holding the canonical copy of every adopted skill. */
export const STORE_SKILLS_NAME = 'skills'

/** File name of the active MCP document. */
export const STORE_MCP_NAME = 'mcp.json'

/** File name of the archived MCP document. */
export const STORE_MCP_ARCHIVE_NAME = 'mcp-archive.json'
 ...
 */
export const STORE_SETTINGS_NAME = 'settings.json'
...
export function storeSettingsPath(): string {
  return join(storeRoot(), STORE_SETTINGS_NAME)
}
 ...
 */
export function ensureStoreRoot(): string {
