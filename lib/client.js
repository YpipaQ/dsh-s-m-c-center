window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function Collapsible({ label, expandLabel, collapseLabel, children }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					className: settings_card_module_css_default.collapsibleBody,
					children
				}) : null]
			});
		}
				...
				children: [
					store !== null && store.migrated ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: format(t("storeMigrated"), { root: store.root || store.dir }) }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [format(t("storeCount"), {
									count: store.count,
									enabled: store.enabled
								}), store.failures.length > 0 ? format(t("storeFailures"), { n: store.failures.length }) : ""] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Collapsible, {
									label: t("storeMigratedTitle"),
									expandLabel: t("expand"),
									collapseLabel: t("collapse"),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: t("storeMigratedNote") })
								})
							]
						})
					}) : null,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							skills.message ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ErrorText, { children: skills.message }) : null,
							skills.error ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ErrorText, { children: skills.error }) : null,
							skills.loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Loading, { t }) : skills.filtered.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EmptyState, { title: skills.total === 0 ? t("emptySkills") : t("emptySkillMatch") }) : skills.groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Badge, { children: skill.managed ? t("badgeStore") : t("badgeInPlace") }),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						archivedCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: settings_card_module_css_default.storeNote,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: settings_card_module_css_default.descWrap,
								children: format(t("mcpArchiveNote"), {
									n: archivedCount,
									store,
									activate: t("activate")
								})
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: settings_card_module_css_default.descWrap,
							children: format(t("mcpStoreNote"), { store })
						})
					]
				})]
			});
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: settings_card_module_css_default.descWrap,
							style: { marginTop: 0 },
							children: format(t("cliIntro"), { store })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: settings_card_module_css_default.descWrap,
							children: t("cliSkillHint")
						}),
		...
		*/
		...
		var SkillsMcpApi = class {
			async listSkills(cwd) {
				return (await call("GET", withCwd(SKILLS_MCP_API.skills, cwd))).items;
			}
			async readSkill(path) {
				return (await call("POST", SKILLS_MCP_API.skillRead, { path })).skill;
			}
			async toggleSkill(path, enabled) {
				await call("POST", SKILLS_MCP_API.skillToggle, {
					path,
					enabled
				});
			}
			async deleteSkill(path, kind) {
				await call("POST", SKILLS_MCP_API.skillDelete, {
					path,
					kind
				});
			}
			async scanSkills(dir) {
				return (await call("POST", SKILLS_MCP_API.skillScan, { dir })).items;
			}
			async importSkills(items) {
				return (await call("POST", SKILLS_MCP_API.skillImport, { items })).results;
			}
			async storeStatus() {
				return (await call("GET", SKILLS_MCP_API.skillStore)).store;
			}
			/** Undo the one-shot migration: every stored skill returns to its origin. */
			async rollbackStore() {
				return (await call("POST", SKILLS_MCP_API.skillRollback, {})).result;
			}
			/** Run the one-shot migration again — the undo for {@link rollbackStore}. */
			async reMigrateStore() {
				return (await call("POST", SKILLS_MCP_API.skillRemigrate, {})).result;
			}
			async listMcp() {
				return (await call("GET", SKILLS_MCP_API.mcp)).servers;
			}
			...
			async setMcpEnabled(name, enabled) {
				await call("POST", SKILLS_MCP_API.mcpEnabled, {
					name,
					enabled
				});
			}
			...
			async restoreAllMcp() {
				return (await call("POST", SKILLS_MCP_API.mcpRestoreAll, {})).restored;
			}
			async testMcp(server) {
				return (await call("POST", SKILLS_MCP_API.mcpTest, { server })).test;
			}
			async listCli(cwd) {
				return (await call("GET", withCwd(SKILLS_MCP_API.cli, cwd))).items;
			}
			async cliState(name, cwd) {
				return (await call("GET", withName(SKILLS_MCP_API.cliState, name, cwd))).state;
			}
			async cliSubcommands(name, cwd) {
				return (await call("GET", withName(SKILLS_MCP_API.cliSubcommands, name, cwd))).subcommands;
			}
			async saveCli(entry) {
				await call("POST", SKILLS_MCP_API.cliSave, { entry });
			}
			async setCliEnabled(name, enabled) {
				await call("POST", SKILLS_MCP_API.cliEnabled, {
					name,
					enabled
				});
			}
			...
			async probeCli(name, cwd) {
				const body = await call("POST", SKILLS_MCP_API.cliProbe, {
					name,
					cwd
				});
				return {
			...
			async getSettings() {
				return (await call("GET", SKILLS_MCP_API.settings)).settings;
			}
			async saveSettings(settings) {
				return (await call("POST", SKILLS_MCP_API.settingsSave, { settings })).settings;
			}
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region src/client/components/UninstallPanel.tsx
		/**
		...
		*/
		/** Uninstall prep tab. */
		function UninstallPanel({ skills, mcp, refresh, t }) {
		...
		function ManagerShell({ cwd, enabled, pickDirectory, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					tab === "uninstall" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UninstallPanel, {
						skills,
						mcp,
						refresh: bump,
						t
