		...
		*/
		...
		function SkillsPanel({ skills, t }) {
			...
			const groups = skills.groups.map((g) => ({
				...g,
				items: g.items.filter((s) => s.managed === isStore)
		...
		function SkillList({ skills, groups, subTotal, isStore, onAdopt, t }) {
			if (skills.loading) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Loading, { t });
			if (groups.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EmptyState, { title: skills.query !== "" ? t("emptySkillMatch") : isStore ? t("emptyStoreTab") : t("emptySkills") });
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				onAdopt,
				t
			}, skill.path))] }, group.level)), skills.total > subTotal ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: settings_card_module_css_default.note,
				children: t("otherSubpageHint")
			}) : null] });
		}
		/** One row: switch (semantics depend on the sub-page), detail, actions. */
		function SkillRow({ skill, skills, onAdopt, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					onAdopt ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
						disabled: isBusy,
						onClick: () => {
							onAdopt(skill);
						},
						children: isBusy ? t("adoptBusy") : t("adopt")
					}) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
						variant: "danger",
						disabled: isBusy,
