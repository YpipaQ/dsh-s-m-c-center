...
`;
		...
		*/
		function openPanel(sessionId, cwd) {
			ensureStyle();
			...
			const render = (skillRows, selected, sessionList) => {
				bodyEl.textContent = "";
			...
			(async () => {
				try {
					const [skillBody, contextBody] = await Promise.all([api$1("GET", cwd !== "" ? `${SMC_API.skills}?cwd=${encodeURIComponent(cwd)}` : SMC_API.skills), api$1("POST", SMC_API.contextsGet, {
						sessionId,
						cwd
					}).then(() => api$1("GET", cwd !== "" ? `${SMC_API.contexts}?cwd=${encodeURIComponent(cwd)}` : SMC_API.contexts))]);
					const selectionBody = await api$1("POST", SMC_API.contextsGet, {
						sessionId,
						cwd
					});
		...
		* holds a selection.
		*/
		function ContextSection({ contexts, skills, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					contexts.sessions.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EmptyState, { title: t("emptyContexts") }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: settings_card_module_css_default.inline,
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
							...
							children: contexts.sessions.map((s) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: s.sessionId,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					redFlag ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
						...
						skill.group !== "native" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
							disabled: isBusy,
							onClick: () => {
								skills.unlink(skill);
							},
						...
						skill.group === "stored" && !skill.linked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
							disabled: isBusy,
							onClick: () => {
								skills.link(skill);
							},
		...
		*/
		function useContexts(options) {
			...
			return {
				...
				setActiveId,
				checked,
				candidates: (0, react.useMemo)(() => skills.filter((s) => s.level === "user" && (s.group === "stored" || s.group === "registered" || s.group === "native")), [skills]),
				busySlug,
				message,
