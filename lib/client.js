...
`;
		...
		*/
		...
		async function toggleSkill(sessionId, slug, cwd) {
		...
		*/
		function openPanel(entry) {
			...
			subTitle.textContent = sessionId === void 0 ? "新会话（尚未开始对话）" : conversation.title || "当前会话";
			...
			const render = (skillRows, selected) => {
				bodyEl.textContent = "";
				if (sessionId === void 0) {
			...
			const load = () => {
				...
				(async () => {
					try {
						const [skillBody, selectionBody] = await Promise.all([api$1("GET", SMC_API.skills), sessionId === void 0 ? Promise.resolve({ selection: { selected: [] } }) : api$1("POST", SMC_API.contextsGet, {
							sessionId,
							cwd
						})]);
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: format(t("contextCount"), { n: totalPicks })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: settings_card_module_css_default.collapsibleAction,
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								...
								onChange: (e) => {
									contexts.setActiveId(e.target.value);
								},
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: contexts.defaultId,
									children: t("contextDefaultItem")
								}), sessions.filter((s) => s.sessionId !== contexts.defaultId).map((s) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: s.sessionId,
									children: format(t("contextSessionItem"), {
						...
						contexts.activeId !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: contexts.candidates.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							}) : contexts.candidates.map((skill) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Badge, { children: t(skill.group === "stored" ? "groupStored" : skill.group === "registered" ? "groupRegistered" : "groupNative") })
								]
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					redFlag ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
						...
						skill.group === "stored" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
							disabled: isBusy,
							onClick: () => {
								skills.unmigrate(skill);
							},
							children: t("btnUnmigrate")
						}) : null,
						...
						(skill.group === "stored" || skill.group === "registered") && !skill.linked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
							disabled: isBusy,
							onClick: () => {
								skills.link(skill);
							},
		...
		*/
		...
		var SkillsMcpApi = class {
			...
			/** The per-skill announcement flag (公告 / 隐藏). */
			async setSkillAnnounce(group, slug, announce) {
				await call("POST", SMC_API.skillAnnounce, {
					group,
					slug,
					announce
				});
		...
		*/
		...
		function useSkills(options) {
			...
			const toggleAnnounce = (0, react.useCallback)((skill) => {
			...
			const unmigrate = (0, react.useCallback)((skill) => {
		...
		//#endregion
		//#region src/client/hooks/useContexts.ts
		/**
		...
		*/
		function useContexts(options) {
			...
			const [message, setMessage] = (0, react.useState)("");
			const reloadSessions = (0, react.useCallback)(() => {
			...
			const reloadActive = (0, react.useCallback)((id) => {
				if (id === null) {
					setChecked({});
					return;
				}
			...
			const candidates = (0, react.useMemo)(() => skills.filter((s) => s.level === "user" && typeof s.slug === "string" && s.slug !== ""), [skills]);
			return {
				sessions,
